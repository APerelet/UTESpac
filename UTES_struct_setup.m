        ...
        if IRGAFlag
            if no_fw
                ...
                output.StructParamHeader = {'Timestamp', ...
                    ...
                    [num2str(sensorInfo.irgaH2O(cntrIRGA, end)), 'm Cu2: m^2 m^-2/3'],...
                    [num2str(sensorInfo.irgaH2O(cntrIRGA, end)), 'm Cv2: m^2 m^-2/3'],...
                    [num2str(sensorInfo.irgaH2O(cntrIRGA, end)), 'm Cw2: m^2 m^-2/3'];...
            ...
            if no_fw
                ...
                output.StructParamHeader = {'Timestamp', ...
                    [num2str(sensorInfo.Tson(qq, end)), 'm CtSon2: K^2 m^-2/3'],...
                    [num2str(sensorInfo.Tson(qq, end)), 'm Cu2: m^2 m^-2/3'],...
                    [num2str(sensorInfo.Tson(qq, end)), 'm Cv2: m^2 m^-2/3'],...
                    [num2str(sensorInfo.Tson(qq, end)), 'm Cw2: m^2 m^-2/3'];...
                    [], num2str(sensorInfo.Tson(qq, end)),...
                    num2str(sensorInfo.Tson(qq, end)),...
                    num2str(sensorInfo.Tson(qq, end)),...
                    num2str(sensorInfo.Tson(qq, end))};
